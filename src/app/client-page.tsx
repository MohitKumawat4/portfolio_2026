      ...
      <div className="inline-flex items-center gap-1 rounded-full backdrop-blur-xl border border-white/[0.12] bg-white/[0.04] px-2 py-2 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_4px_20px_rgba(0,0,0,0.3)]">
        <div className="relative w-9 h-9">
          ...
          <div className="absolute inset-[2px] rounded-full bg-[#0a0a0a] flex items-center justify-center z-10 overflow-hidden">
            <img src="/mk.png" alt="Mohit Kumawat" className="w-full h-full object-cover" />
          </div>
        </div>
              ...
              >
                <div className="rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-4 sm:p-6 md:p-8 shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-3">
                    ...
                    <div className="md:hidden rounded-[30px] overflow-hidden bg-[#141414]" style={{ height: "70vh", maxHeight: "600px" }}>
                      <img
                        src={project.image}
                        alt={`${project.title} preview`}
                        loading="lazy"
...
function SocialDock() {
  ...
  return (
    <motion.div
      ...
      className="hidden md:flex fixed right-4 md:right-6 top-1/2 -translate-y-1/2 z-50 flex-col items-center gap-2"
    >
          ...
          {socials.map((social) => {
            ...
            return (
              <div key={social.name} className="relative">
                ...
                <El
                  {...props}
                  className="block w-10 h-10 p-2 rounded-xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] text-white/60 hover:text-white hover:bg-white/[0.06] transition-all duration-200"
                  title={social.name}
                >
                  {social.icon}
                </El>
                {isCopyAction && copied && (
                  <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-xs text-green-400 whitespace-nowrap bg-[#0a0a0a] px-2 py-1 rounded">
                    Copied!
                  </span>
                )}
              </div>
